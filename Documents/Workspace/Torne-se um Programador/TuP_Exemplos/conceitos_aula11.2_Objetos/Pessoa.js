...
Pessoa.metodoEstatico = function(){ // não é necessário instanciar um objeto para utilizar este método
	alert("Este e um metodo estatico de Pessoa.");
}

Pessoa.essencia = "Toda pessoa e um ser vivo!" // atributo estático